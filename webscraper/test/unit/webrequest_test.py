...
class WebRequestTest(WebRequest, TestCase):
    ...
    def set_url_padding_test_two(self):
        ...
        self.set_url_padding(url_padding)
        self.test.assertNotEqual(self.url_padding, url_padding, self.ERROR_MSG
    ...
    def add_recursive_url_test_one(self):
        ...
        self.test.assertEqual(self.recursive_urls[0], rec_url, self.ERROR_MSG
                              + 'recursive url not in list')
